...
public class EventSubscriber: IEventSubscriber
{
    ...
    public EventSubscriber(ILogger<EventSubscriber> logger, IConnection connection, IServiceScopeFactory scopeFactory, IOptions<RabbitOptions> options)
    {
        ...
        this.consumerChannel = CreateConsumerChannel().Result;
    }
    ...
    public async Task Subscribe(Type eventType, Type eventHandlerType)
    {
        ...
        await this.consumerChannel.QueueDeclareAsync(queueName, true, exclusive: false);
        ...
        await this.consumerChannel.BasicConsumeAsync(queueName, false, consumer);
        ...
        await this.consumerChannel.QueueBindAsync(queueName, this.options.ExchangeName, eventName);
    }
